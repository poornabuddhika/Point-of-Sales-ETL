...
namespace IMS.App.AppCass.Category
{
    class BrandFormClass
    {
        ...
        public void RefreshBrandContent(TextBox textBrandName, TextBox textBrandTAG, TextBox textBrandSearch, CheckBox checkBoxBrandISActive, Label ErrorlabelBrandName, Label ErrorlabelBrandTag)
        {
            textBrandName.Clear();
            textBrandTAG.Clear();
            textBrandSearch.Clear();
            checkBoxBrandISActive.Checked = true; 
            ErrorlabelBrandName.Hide();
            ErrorlabelBrandTag.Hide();
        }
