...
namespace IMS.App.AppCass.Category
{
    class RackNumberFormClass
    {
        ...
        public void RefreshRackContent(TextBox textBoxRackNumber,TextBox textRackSearch, Label ErrorlabelRacNum,CheckBox checkBoxRack)
        {
            textBoxRackNumber.Clear();
            textRackSearch.Clear();
            ErrorlabelRacNum.Hide();
            checkBoxRack.Checked = true;
        }
